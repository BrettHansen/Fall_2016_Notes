...
Suppose a task can be broken into $k$ subtasks, $t_1,t_2,\ellipsis,t_k$, and further suppose there are $c_i$ ways to perform subtask $t_i$ and each way leads to an unique result. Then the number of ways to perform the task is $c_1 \cdot c_2 \ellipsis c_k$.
